      ...
      .insert([
        {
          ...
          discharge_start_time: input.dischargeStartTime || null, 
          discharge_end_time: input.dischargeEndTime || null,     
          slot_id: input.slotId,          
          target_soc: input.targetSoc,
          status: 'reserved',
          total_cost: input.totalCost,
          is_v2g: input.enableV2G ?? false, 
          v2g_revenue: input.v2gRevenue ?? 0,             
          v2g_profit: input.v2gProfit ?? 0                      
        }
      ])
      .select()
      .single();
